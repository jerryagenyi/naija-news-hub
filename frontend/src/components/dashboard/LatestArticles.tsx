...
// Define types for our hardcoded data
interface Article {
  id: number;
  title: string;
  author: string;
...
const hardcodedArticles: Article[] = [
  {
    id: 1,
    title: 'Nigeria Announces New Economic Policy',
    author: 'John Doe',
    category: 'Politics',
    source: 'Punch News',
    publishedAt: '2024-04-18T10:30:00Z',
    tags: ['Economy', 'Government', 'Policy'],
  },
  {
    id: 2,
    title: 'Tech Startups in Lagos Receive Major Funding',
    author: 'Jane Smith',
    category: 'Technology',
    source: 'TechCabal',
    publishedAt: '2024-04-17T14:15:00Z',
    tags: ['Startups', 'Funding', 'Lagos'],
  },
  {
    id: 3,
    title: 'Super Eagles Prepare for World Cup Qualifiers',
    author: 'Mike Johnson',
    category: 'Sports',
    source: 'Complete Sports',
    publishedAt: '2024-04-16T08:45:00Z',
    tags: ['Football', 'Super Eagles', 'World Cup'],
  },
  {
    id: 4,
    title: 'New Health Initiative Launched in Abuja',
    author: 'Sarah Williams',
    category: 'Health',
    source: 'Health Nigeria',
    publishedAt: '2024-04-15T11:20:00Z',
    tags: ['Healthcare', 'Abuja', 'Initiative'],
  },
  {
    id: 5,
    ...
    publishedAt: '2024-04-14T16:30:00Z',
    tags: ['Nollywood', 'Awards', 'Film'],
  },
];

// Total number of articles (for pagination)
const totalArticlesCount = 15;

export default function LatestArticles() {
  const [articles] = useState<Article[]>(hardcodedArticles);
                ...
                <div>
                  <p className="text-sm text-gray-700 dark:text-gray-300">
                    ...
                    <span className="font-medium">
                      {Math.min(page * articlesPerPage, totalArticlesCount)}
                    </span>{' '}
                    of <span className="font-medium">{totalArticlesCount}</span> results
                  </p>
                </div>
                <div>
                  <nav className="relative z-0 inline-flex rounded-md shadow-sm -space-x-px" aria-label="Pagination">
                    ...
                    <button
                      ...
                      disabled={page * articlesPerPage >= totalArticlesCount}
                      className={`relative inline-flex items-center px-2 py-2 rounded-r-md border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-sm font-medium ${
                        page * articlesPerPage >= totalArticlesCount
                          ? 'text-gray-300 dark:text-gray-600 cursor-not-allowed'
                          : 'text-gray-500 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700'
                      }`}
                    >
